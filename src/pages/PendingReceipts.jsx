    ...
    <section className="flex flex-col gap-6">
      <header className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="rounded-full border border-[#1f1b17] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#1f1b17] transition-all duration-150 hover:bg-[#1f1b17] hover:text-[#fef7ed] active:scale-95 shadow-[0_4px_10px_-6px_rgba(31,27,23,0.15)]"
        >
          Export list
        </button>
      </header>
                ...
                <div key={payment.id} className="flex flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="rounded-full bg-[#f2c278] hover:bg-[#eeb156] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#4d3510] transition-all duration-150 active:scale-95 shadow-[0_4px_10px_-6px_rgba(242,194,120,0.4)]"
                    >
                      Issue receipt
                    </button>
                  </div>
